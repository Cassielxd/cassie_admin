<template>
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmitHandle()" label-width="120px">
      <el-form-item prop="dict_value" :label="$t('dict.dictValue')">
        <el-input v-model="dataForm.dict_value" :placeholder="$t('dict.dictValue')"></el-input>
      </el-form-item>
      <el-form-item prop="dict_label" :label="$t('dict.dictLabel')">
        <el-input v-model="dataForm.dict_label" :placeholder="$t('dict.dictLabel')"></el-input>
      </el-form-item>
